...
Using data and findings from the housing gap analysis, FAAR could help orchestrate an educational campaign about the opportunities for workforce and economic development to collaborate in the housing field. One example to potentially emulate is [Workforce Housing Now](https://workforcehousingnow.org/), an initiative led by the Community Foundation of Loudoun and Northern Fauquier Counties. They describe the it as
