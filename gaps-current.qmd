...
```{r}
#ACS B25009 Household Size of Occupied Housing Units by Tenure
...
# Read the data
b25009_data <- read_rds("data/b25009_region.rds")

# Inspect the data structure
str(b25009_data)

faar_hhsize <- b25009_data |> 
...
## need help getting tenure type in here -- when I try to run code for this data set, tenure type is lost somehow. 
