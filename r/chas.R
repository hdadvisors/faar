...
cb_9 <- read_csv("data/Table9_2019to2020.csv") |> 
  clean_names() |> 
  filter(line_type == "Detail")  |> 
  mutate(tenure = case_when(
    tenure == "Owner occupied" ~ "Homeowner",
...
tb_18a <- read_csv("data/Table18A_2019to2020.csv") |> 
  clean_names() |> 
  filter(line_type == "Detail")

tb_18b <- read_csv("data/Table18B_2019to2020.csv")
...
tb_18a <- read_csv("data/Table18C_2012to2019.csv")
tb_18b <- read_csv("data/Table18C_2012to2019.csv")
