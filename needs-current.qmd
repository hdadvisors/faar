...
costs_income_change <- costs_income |> 
  ...
  mutate(
    ...
    price_chg = (Median_Sales_Price - lag(Median_Sales_Price)),
    inc_chg = (Average_Annual_Salary - lag(Average_Annual_Salary))
  ) |> 
  mutate(
  ...
  mutate(
    ...
    price_pct = price_chg/first(Median_Sales_Price),
    inc_pct = inc_chg/first(Average_Annual_Salary)
  ) |> 
 select(name, year, rent_pct, price_pct, inc_pct) |>  
  pivot_longer(
