...
#custom_order <- factor(
#  owner_supply$monthly,
#  levels = c(
#    "Less than $599", "$600 to $999", "$1,000 to $1,499",
#    "$1,500 to $1,999", "More than $2,000"
#    )
#  )

ggplot(owner_supply, aes(x = monthly, y = adj_estimate)) +
  geom_col(fill = hda_pal[1]) +
  theme_hda() +
  scale_y_continuous(labels = label_comma()) +
  add_zero_line() +
  labs(
    title = "Existing homeowner supply by monthly cost",
