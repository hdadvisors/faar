...
There are a little over 101,000 homeownership units throughout the region.[^1] On the farthest ends of the homeownership spectrum, about 15,000 units cost less than $599 per month, whereas there are over 45,000 units with more than $2,000 in monthly costs. This indicates that there are fewer units affordable to low to middle income homeowners and buyers. In order to keep housing costs at 30% and below of income, a household would need to make at least $80,000 per year to afford $2000 in housing costs.

There are far fewer ownership units that cost less than $1,500 per month than the total number of units that cost more than $2000 monthly. Sixty two percent of homeownership units, in fact, cost more than $1500 per month. While these estimates encompass homeowner households without mortgages, this suggests that low-cost homeownership opportunities are few and far between, favoring larger, higher cost homes.


[^1]:  This estimate includes units that are vacant, but “For sale only” and “Sold, not occupied”. These units are distributed across rental units based on the distribution by cost.
...
Additionally, as these data incorporate market trends from the last four years, and the for-sale housing market has changed drastically in that time, especially in more recent years. Interest rates, which have the greatest potential to influence monthly mortgage payments, have peaked at 7.79% in October 2023  and settled around 6.95% as of July 2024. While regional resales peaked in 2021, likely with much lower purchase prices and interest rates, recent home sales with increased pricing and rates may influence these data by pulling monthly housing costs for all ownership units higher.  
